...
export class ElectoralProcessController {
    ...
    @Get(':electoralId/political-party-participants/votes')
    async getPoliticalParticipantsWithVotesByElectoralId(@Param('electoralId', ParseIntPipe) electoralId: number){
        return this.client.send({cmd: 'getPoliticalParticipantsWithVotesByElectoralId' },electoralId);
    }
    ...
    @Get(':id/votes-in-blockchain')
    async getVotesByElectoralIdBlockchain(@Param('id', ParseIntPipe) electoralId: number){
        return this.studentService.send({cmd: 'findCountVotesByElectoralIdBlockchain'},electoralId);
    }
}